...
ALL['qMDDmet'] = ['MDD'] #  ['coMDD','CS','MDD','FT']
...
if load_data==False:
    ...
    #l = range(52,54,2); DAT['NIarr']['CS'] = l[::-1]; DAT['NIarr']['MDD'] = l[::-1]; DAT['NIarr']['FT'] = l[::-1]
    TB.getrelax(DAT,DAT['qMDDmet']) #x,y,par
    #gui_simple.loadgui(DAT)
    #TB.plotrelaxation([DAT],DAT['qMDDmet'],peaks=(DAT['peakrange']['MDD'][:10]+['57']))
    #TB.plotrelaxation([DAT],['MDD'],NIa=[36],peaks=(['24']))
##    psel = [2, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13, 15, 17, 18, 19, 21, 22, 23, 24, 26, 27, 29, 30, 31, 32, 33, 34, 36, 38, 40, 41, 42, 43, 46, 48, 49, 50, 52, 54, 55, 56, 57, 58, 59, 60, 61, 63, 66, 67, 68, 69, 70, 71, 74, 75, 76, 78, 79, 80, 81, 82]
...
##    #TB.plot_single_pearson(DAT,'R2',mets=['coMDD'],NIa=[128,122],Ini=True) #TB.plot_single_pearson(DAT,'R2',['coMDD','CS'],NIa=[128,122],Ini=True)
